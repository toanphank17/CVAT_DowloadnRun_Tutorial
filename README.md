...
Dưới đây là video hướng dẫn chi tiết cách tạo Polygon Annotation (gán nhãn đa giác) và xuất dữ liệu bằng CVAT:

[![How to create Polygon Annotation](https://img.youtube.com/vi/FOfUueO-NnI/maxresdefault.jpg)](https://www.youtube.com/watch?v=FOfUueO-NnI)

> 💡 *Nhấn vào ảnh trên để xem video hướng dẫn chi tiết trên YouTube.*
